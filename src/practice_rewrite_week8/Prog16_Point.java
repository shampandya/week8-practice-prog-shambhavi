...
public class Prog16_Point {
    ...
    public double distance(Prog16_Point secondPoint) {
        return distance(secondPoint.x, secondPoint.y);
    }

    public static void main(String[] args) {
        Prog16_Point first = new Prog16_Point(6, 5);
        Prog16_Point second = new Prog16_Point(3, 1);
        System.out.println("distance(0,0)= " + first.distance());
        System.out.println("distance(second)= " + first.distance(second));
        System.out.println("distance(2,2)= " + first.distance(2, 2));
        Prog16_Point point = new Prog16_Point();
        System.out.println("distance()= " + point.distance());
    }
}
